...
bool grayman::init(){
	...
	m_world = m_world *_translate(_vec3(0.0f,-15.0f,0.0f));
...
bool grayman::update(){
	...
	app_throw_hr(_fx->SetTechnique(_api_manager->m_htech_bone));
	...
	app_throw_hr(_api_manager->m_d3ddevice->SetVertexDeclaration(_api_manager->m_ui_bone_vertex_declaration));
